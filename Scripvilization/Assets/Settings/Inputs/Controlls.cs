...
//     version 1.13.1
//     from Assets/Settings/Inputs/Controlls.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Settings/Inputs/Controlls.inputactions".
/// </summary>
/// <remarks>
...
public partial class @Controlls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Zoom"",
                    ""type"": ""Value"",
                    ""id"": ""dd41d04e-f406-403a-99f6-cc251eca8066"",
                ...
                },
                {
                    ""name"": ""Turn"",
                    ""type"": ""Value"",
                    ""id"": ""6e1baaa9-53e8-404a-9130-788af14ba094"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""Reset"",
                    ""type"": ""Button"",
                    ""id"": ""70d397c4-3b8a-4a6d-b041-ee91772a2988"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""MousePosition"",
                    ""type"": ""Value"",
                    ""id"": ""ccbc25a4-dedc-4b61-a98a-7c608eca65a4"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""da0329ff-8ce4-4bf4-9417-636cd596307a"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""b8f9174b-d4b8-4a67-b2ec-cf1f1775a006"",
                    ""path"": ""<Mouse>/scroll"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""ad170674-10cf-424a-a2f2-2e6f594abbb0"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""59e37ee2-5312-4c37-967a-a57674c37717"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""b5714792-9e63-45e5-8ab9-184aafceaf8c"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""9ba65043-2338-4035-8a49-0c851bbb154d"",
                    ""path"": ""<Keyboard>/q"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""25daabb1-b270-4a6e-86ca-373612110313"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""3036a604-9952-41f8-9d4f-77f87695fc47"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
    ...
    ~@Controlls()
    {
        ...
        UnityEngine.Debug.Assert(!m_Script.enabled, "This will cause a leak and performance issues, Controlls.Script.Disable() has not been called.");
    }
    ...
    public struct ScriptActions
    {
        ...
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_Script; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="ScriptActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(ScriptActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        public void AddCallbacks(IScriptActions instance)
        {
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="ScriptActions.UnregisterCallbacks(IScriptActions)" />.
        /// </summary>
        /// <seealso cref="ScriptActions.UnregisterCallbacks(IScriptActions)" />
        public void RemoveCallbacks(IScriptActions instance)
        {
            if (m_Wrapper.m_ScriptActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="ScriptActions.AddCallbacks(IScriptActions)" />
        /// <seealso cref="ScriptActions.RemoveCallbacks(IScriptActions)" />
        /// <seealso cref="ScriptActions.UnregisterCallbacks(IScriptActions)" />
        public void SetCallbacks(IScriptActions instance)
        {
            foreach (var item in m_Wrapper.m_ScriptActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_ScriptActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="ScriptActions" /> instance referencing this action map.
    /// </summary>
    public ScriptActions @Script => new ScriptActions(this);
    ...
    public interface IPlayerActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "MouseSelect" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Script" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="ScriptActions.AddCallbacks(IScriptActions)" />
    /// <seealso cref="ScriptActions.RemoveCallbacks(IScriptActions)" />
